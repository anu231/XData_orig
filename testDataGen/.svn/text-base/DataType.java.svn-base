...
//		  SQLXML = 2009;
	...
	public static void main(String[] args) throws Exception {
	    ...
	    try {
	        ...
	        ResultSet resultSet = metadata.getColumns(null, null, "rollhist", null);
	        ...
	        PreparedStatement pstmt = connection.prepareStatement("select * from rollhist where studentid = 70626");
	        ...
	        for(int i=1; i<=rsmd.getColumnCount(); i++)
	        {
	        	...
	        	System.out.println("datatype = " + datatype + "; our type = " + d.getDataType(datatype) );
