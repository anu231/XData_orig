...
public class EquivalenceClass {
			...
			while (tempAllJoinConds1.size() > 0) {
				...
				for (int j = 0; j < ec1.size(); j++) {
					...
					for (int k = 0; k < tempAllJoinConds1.size(); k++) {
						...
						temp4 = ec1.get(j);
						System.out.println("Comparing " + temp3.toString()
								+ " and " + temp4.toString());
							...
							if (temp3.getLeft().getColumn().getColumnName()
									.equalsIgnoreCase(
											...
											.equalsIgnoreCase(
													temp4.getColumn()
													.getTableName())) {
								System.out.println("Added " + temp3.toString());
				...
				System.out.println("Added EC: " + ec1.toString());
	...
	public static Vector<Vector<Node>> createEquivalenceClasses(QueryParser qParser) {
		...
		System.out.println("Final Equivalence Classes:\n"+ecs.toString());
		return ecs;
	}
