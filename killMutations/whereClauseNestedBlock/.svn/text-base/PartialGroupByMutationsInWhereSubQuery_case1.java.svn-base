	...
	public static void generateDataForkillingParialGroupByMutationsInWhereSubquery(GenerateCVC1 cvc) throws Exception{
		...
		for(Conjunct con: cvc.getOuterBlock().getConjuncts()){
			...
			for(Node subQCond: con.getAllSubQueryConds()){
				...
				System.out.println("\n----------------------------------");
				System.out.println("GENERATE DATA FOR KILLING PARTIAL GROUP BY MUTATIONS IN WHERE CLAUSE NESTED SUBQUERY BLOCK: Case 1: "+ qbt);
				System.out.println("----------------------------------\n");
				...
				for(Node tempgroupByNode : groupbyNodes){
					...
					System.out.println("\n----------------------------------");
					System.out.println("KILLING PARTIAL GROUP BY MUTATIONS IN WHERE CLAUSE NESTED SUBQUERY BLOCK: " + tempgroupByNode);
					System.out.println("\n----------------------------------");
